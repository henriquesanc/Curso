...
public class PotenciaComMultiplicaccao {
    public static void main(String[] args) {
		...
		if (base < 0 && expoente > 0) {
			...
			JOptionPane.showMessageDialog(null, base + " elevado por " + expoente + " � igual a: " + potencia);
			System.exit(0);
		} else if (base < 0 && expoente == 0) {
			JOptionPane.showMessageDialog(null, base + " elevado por " + expoente + " � igual a: 1");
			System.exit(0);
		} else if (base < 0 && expoente < 0) {
			expoente = -expoente;
			for (; contador < expoente; contador++) {
